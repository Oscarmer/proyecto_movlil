...
import com.oscar.storeapp.databinding.FragmentAdminBinding
...
class AdminFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val button2 = view.findViewById<Button>(R.id.close)
        button2?.setOnClickListener {
            findNavController().navigate(R.id.btPublicar, null)
